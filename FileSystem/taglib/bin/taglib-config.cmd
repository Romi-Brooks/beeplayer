...
:doit
if /i "%1#" == "--libs#"    echo -LD:/Project/taglib-2.1.1/taglib-2.1.1/install/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/Project/taglib-2.1.1/taglib-2.1.1/install/include -ID:/Project/taglib-2.1.1/taglib-2.1.1/install/include/taglib
if /i "%1#" == "--version#" echo 2.1.1
if /i "%1#" == "--prefix#"  echo D:/Project/taglib-2.1.1/taglib-2.1.1/install
